(function () {
  ...
  var translations = {
    en: {
      ...
      'product.music.desc': 'Music player and downloader for Windows & Linux. Stream, download, and manage your music library with a modern interface. Supports online sources, local files, playlists, synced lyrics, audio visualizer, equalizer, and internet radio. No ads, no tracking, completely free.',
      'product.music.hero.title': 'Klat Music',
      'product.music.feat1.title': 'Online Streaming',
      'product.music.feat1.desc': 'Stream music from multiple online sources. Search millions of songs, listen instantly, no account required.',
      'product.music.feat2.title': 'Music Download',
      'product.music.feat2.desc': 'Download songs for offline listening. Choose quality from 128kbps to 320kbps. Supports FLAC lossless format.',
      'product.music.feat3.title': 'Smart Playlists',
      'product.music.feat3.desc': 'Create and manage playlists with drag & drop. Auto-playlist based on genre, mood, or recently played. Import/export M3U.',
      'product.music.feat4.title': 'Smart Search',
      'product.music.feat4.desc': 'Search by title, artist, album, or lyrics. Instant results with album art previews. Sort by popularity, date, or duration.',
      'product.music.feat5.title': 'Synced Lyrics',
      'product.music.feat5.desc': 'Real-time synced lyrics display. Karaoke-style highlighting as the song plays. Search and display lyrics for any track.',
      'product.music.feat6.title': 'Audio Visualizer',
      'product.music.feat6.desc': 'Beautiful audio visualizations with multiple spectrum modes. Customize colors and effects. GPU-accelerated rendering.',
      'product.music.feat7.title': 'Equalizer & Effects',
      'product.music.feat7.desc': '10-band graphic equalizer with presets. Bass boost, reverb, crossfade, gapless playback. Customize your sound.',
      'product.music.feat8.title': 'Tag Editor',
      'product.music.feat8.desc': 'Edit ID3 tags, album art, and metadata. Batch edit multiple files. Auto-fetch album art and tag info from online databases.',
      'product.music.feat9.title': 'Internet Radio',
      'product.music.feat9.desc': 'Thousands of internet radio stations worldwide. Browse by genre, country, or language. Add custom radio streams.',
      'product.music.use1.title': 'Music Lovers',
      'product.music.use1.desc': 'Build and organize your music library. Discover new songs, create mood playlists, and enjoy hi-fi audio quality.',
      'product.music.use2.title': 'Students & Workers',
      'product.music.use2.desc': 'Focus music and background soundscapes. Download playlists for study sessions. No ads, no distractions.',
      'product.music.use3.title': 'Radio Enthusiasts',
      'product.music.use3.desc': 'Listen to thousands of internet radio stations. Discover music from around the world. Record radio streams.',
      'product.music.use4.title': 'Content Creators',
      'product.music.use4.desc': 'Find royalty-free music for your videos and podcasts. Edit tags and organize your audio assets efficiently.',
      'product.music.tech1.title': 'Supported Formats',
      'product.music.tech2.title': 'System Requirements',
      'product.music.tech3.title': 'Audio Engine',
      'product.music.tech4.title': 'Library Management',
      'product.music.faq1.q': 'Is Klat Music free?',
      'product.music.faq1.a': 'Yes! Klat Music is 100% free and open source (GPL-3.0). No subscriptions, no ads, no in-app purchases. All features are included.',
      'product.music.faq2.q': 'Can I listen offline?',
      'product.music.faq2.a': 'Yes! Download songs for offline listening. Your downloaded music is stored locally and accessible without internet.',
      'product.music.faq3.q': 'What audio formats are supported?',
      'product.music.faq3.a': 'Klat Music supports MP3, FLAC, OGG Vorbis, Opus, AAC, M4A, WAV, AIFF, and WMA. Both lossy and lossless formats are supported.',
      'product.music.faq4.q': 'Does it support lyrics?',
      'product.music.faq4.a': 'Yes! Klat Music fetches and displays synced lyrics in real-time with karaoke-style highlighting. You can also add custom LRC files.',
      'product.music.faq5.q': 'Can I import my existing music library?',
      'product.music.faq5.a': 'Yes! Klat Music scans your existing music directories and imports all supported formats. It reads ID3 tags and organizes your library automatically.',
      'product.music.faq6.q': 'Does it work on macOS?',
      'product.music.faq6.a': 'Klat Music is available on Windows and Linux. macOS support is planned for a future release.',
      'product.sis.desc': 'Comprehensive School Information System built with Laravel 12 backend and React + Vite + TypeScript frontend. Manages students, teachers, academics, attendance, grades, CBT exams, e-learning, finances, and parent portal. RBAC multi-role system, offline mode, real-time dashboard, AI-powered analytics, and full Indonesian education support.',
      'product.sis.featuresTitle': 'Complete <span>School Management</span>',
      'product.sis.feat1.title': 'Multi-Role RBAC',
      'product.sis.feat1.desc': 'JWT + 2FA authentication with role-based access control. Support for admin, principal, teacher, student, parent, and staff roles with granular permissions.',
      'product.sis.feat2.title': 'Attendance System',
      'product.sis.feat2.desc': 'Manual entry, QR code scan, RFID card, and fingerprint attendance. Real-time tracking, geo-fencing, late/early detection, and automatic parent notifications.',
      'product.sis.feat3.title': 'Grade Management',
      'product.sis.feat3.desc': 'Pengetahuan, Keterampilan, Sikap, Rapor, and Ranking. Automated report cards, class ranking, subject analysis, and GPA calculation per Indonesian curriculum standards.',
      'product.sis.feat4.title': 'CBT Online Exams',
      'product.sis.feat4.desc': 'Question bank management, random question selection, exam timer, auto-correction, anti-cheat measures, and instant result analytics for Computer Based Testing.',
      'product.sis.feat5.title': 'e-Learning Platform',
      'product.sis.feat5.desc': 'Learning materials, assignments, discussion forums, file submissions, grading, and progress tracking. Built-in LMS without needing separate platforms.',
      'product.sis.feat6.title': 'Finance & SPP',
      'product.sis.feat6.desc': 'Tuition (SPP) management, invoice generation, payment tracking, installment plans, overdue reminders, and comprehensive financial reports for school administration.',
      'product.sis.feat7.title': 'Parent Portal',
      'product.sis.feat7.desc': 'Dedicated parent view for grades, attendance, schedules, payment status, teacher communication, and chat. Keep parents involved in their child\'s education.',
      'product.sis.feat8.title': 'AI Analytics',
      'product.sis.feat8.desc': 'AI-powered student performance analysis, dropout prediction, learning pattern insights, automated recommendations, and natural language chatbot for school data queries.',
      'product.sis.feat9.title': 'Notifications',
      'product.sis.feat9.desc': 'WhatsApp, Email, and Telegram notifications for attendance, grades, payments, announcements, and emergency alerts. Parents and students stay informed automatically.',
      'product.sis.use1.title': 'Elementary & Middle School',
      'product.sis.use1.desc': 'SD, SMP management with Kurikulum Merdeka support. Attendance, report cards, parent communication, and SPP billing for daily operations.',
      'product.sis.use2.title': 'High School & Vocational',
      'product.sis.use2.desc': 'SMA/SMK with major specialization (Jurusan), competency tracking, graduation requirements, and university preparation data management.',
      'product.sis.use3.title': 'Education Offices',
      'product.sis.use3.desc': 'Dinas Pendidikan managing multiple schools. Aggregate dashboards, district-wide reporting, teacher assignments, and centralized policy management.',
      'product.sis.use4.title': 'Tutoring & Courses',
      'product.sis.use4.desc': 'Bimbel and course centers with student enrollment, class scheduling, attendance, progress tracking, and payment management for flexible learning.',
      'product.sis.tech1.title': 'Backend Stack',
      'product.sis.tech2.title': 'Frontend Stack',
      'product.sis.tech3.title': 'Database & Performance',
      'product.sis.tech4.title': 'Security & Integration',
      'product.sis.downloadTitle': 'Get Klat SIS <span>Today</span>',
      'product.sis.downloadDocker': 'Deploy with Docker',
      'product.sis.faq1.q': 'Is Klat SIS free?',
      'product.sis.faq1.a': 'Yes! Klat SIS is 100% free and open source (GPL-3.0). No subscription fees, no per-student fees, no hidden costs. All features are available including CBT, e-learning, and AI analytics.',
      'product.sis.faq2.q': 'How many students can it handle?',
      'product.sis.faq2.a': 'Klat SIS supports 100K+ student records with optimized queries, proper indexing, and Redis caching. Tested with single schools of 5,000+ students and district-wide deployments of 100,000+.',
      'product.sis.faq3.q': 'Does it support Kurikulum Merdeka?',
      'product.sis.faq3.a': 'Yes! Klat SIS fully supports Kurikulum Merdeka (Indonesia\'s current curriculum) including PPKn, assessment types (Pengetahuan, Keterampilan, Sikap), and P5 project tracking. Also supports Kurikulum 2013 for transition periods.',
      'product.sis.faq4.q': 'Can it work offline?',
      'product.sis.faq4.a': 'Yes! Klat SIS has an offline-first PWA architecture. Teachers and students can use the system without internet. Data syncs automatically when connection is restored. Perfect for areas with unreliable internet.',
      'product.sis.faq5.q': 'How does the CBT system work?',
    ...
    id: {
      ...
      'product.music.desc': 'Pemutar dan pengunduh musik untuk Linux. Streaming, unduh, dan kelola perpustakaan musik Anda dengan antarmuka modern. Mendukung sumber online, file lokal, playlist, lirik sinkron, visualizer audio, equalizer, dan radio internet. Tanpa iklan, tanpa tracking, sepenuhnya gratis.',
      'product.music.hero.title': 'Klat Music',
      'product.music.feat1.title': 'Streaming Online',
      'product.music.feat1.desc': 'Streaming musik dari berbagai sumber online. Cari jutaan lagu, dengarkan langsung, tanpa perlu akun.',
      'product.music.feat2.title': 'Unduh Musik',
      'product.music.feat2.desc': 'Unduh lagu untuk mendengarkan secara offline. Pilih kualitas dari 128kbps hingga 320kbps. Mendukung format lossless FLAC.',
      'product.music.feat3.title': 'Playlist Cerdas',
      'product.music.feat3.desc': 'Buat dan kelola playlist dengan drag & drop. Auto-playlist berdasarkan genre, mood, atau yang baru diputar. Import/export M3U.',
      'product.music.feat4.title': 'Pencarian Cerdas',
      'product.music.feat4.desc': 'Cari berdasarkan judul, artis, album, atau lirik. Hasil instan dengan pratinjau album art. Urutkan berdasarkan popularitas, tanggal, atau durasi.',
      'product.music.feat5.title': 'Lirik Sinkron',
      'product.music.feat5.desc': 'Tampilan lirik sinkron real-time. Penyorotan gaya karaoke saat lagu diputar. Cari dan tampilkan lirik untuk lagu apapun.',
      'product.music.feat6.title': 'Visualizer Audio',
      'product.music.feat6.desc': 'Visualisasi audio indah dengan berbagai mode spektrum. Kustomisasi warna dan efek. Rendering GPU-accelerated.',
      'product.music.feat7.title': 'Equalizer & Efek',
      'product.music.feat7.desc': 'Equalizer grafis 10-band dengan preset. Bass boost, reverb, crossfade, gapless playback. Kustomisasi suara Anda.',
      'product.music.feat8.title': 'Editor Tag',
      'product.music.feat8.desc': 'Edit tag ID3, album art, dan metadata. Edit batch beberapa file. Auto-fetch album art dan info tag dari database online.',
      'product.music.feat9.title': 'Radio Internet',
      'product.music.feat9.desc': 'Ribuan stasiun radio internet di seluruh dunia. Jelajahi berdasarkan genre, negara, atau bahasa. Tambahkan stream radio kustom.',
      'product.music.use1.title': 'Pecinta Musik',
      'product.music.use1.desc': 'Bangun dan organisasi perpustakaan musik Anda. Temukan lagu baru, buat playlist mood, dan nikmati kualitas audio hi-fi.',
      'product.music.use2.title': 'Pelajar & Pekerja',
      'product.music.use2.desc': 'Musik fokus dan suara latar. Unduh playlist untuk sesi belajar. Tanpa iklan, tanpa gangguan.',
      'product.music.use3.title': 'Penggemar Radio',
      'product.music.use3.desc': 'Dengarkan ribuan stasiun radio internet. Temukan musik dari seluruh dunia. Rekam stream radio.',
      'product.music.use4.title': 'Kreator Konten',
      'product.music.use4.desc': 'Temukan musik royalty-free untuk video dan podcast Anda. Edit tag dan organisasi aset audio Anda secara efisien.',
      'product.music.tech1.title': 'Format yang Didukung',
      'product.music.tech2.title': 'Spesifikasi Minimum',
      'product.music.tech3.title': 'Audio Engine',
      'product.music.tech4.title': 'Manajemen Perpustakaan',
      'product.music.faq1.q': 'Apakah Klat Music gratis?',
      'product.music.faq1.a': 'Ya! Klat Music 100% gratis dan open source (GPL-3.0). Tanpa langganan, tanpa iklan, tanpa pembelian dalam aplikasi. Semua fitur tersedia.',
      'product.music.faq2.q': 'Bisakah mendengarkan secara offline?',
      'product.music.faq2.a': 'Ya! Unduh lagu untuk mendengarkan secara offline. Musik yang diunduh disimpan lokal dan dapat diakses tanpa internet.',
      'product.music.faq3.q': 'Format audio apa yang didukung?',
      'product.music.faq3.a': 'Klat Music mendukung MP3, FLAC, OGG Vorbis, Opus, AAC, M4A, WAV, AIFF, dan WMA. Baik format lossy maupun lossless didukung.',
      'product.music.faq4.q': 'Apakah mendukung lirik?',
      'product.music.faq4.a': 'Ya! Klat Music mengambil dan menampilkan lirik sinkron real-time dengan penyorotan gaya karoka. Anda juga bisa menambahkan file LRC kustom.',
      'product.music.faq5.q': 'Bisakah mengimpor perpustakaan musik yang sudah ada?',
      'product.music.faq5.a': 'Ya! Klat Music memindai direktori musik Anda yang sudah ada dan mengimpor semua format yang didukung. Membaca tag ID3 dan mengorganisasi perpustakaan Anda secara otomatis.',
      'product.music.faq6.q': 'Apakah bisa di macOS?',
      'product.music.faq6.a': 'Klat Music tersedia di Windows dan Linux. Dukungan macOS direncanakan untuk rilis mendatang.',
      'product.sis.desc': 'Sistem Informasi Sekolah lengkap dengan backend Laravel 12 dan frontend React + Vite + TypeScript. Mengelola siswa, guru, akademik, kehadiran, nilai, ujian CBT, e-learning, keuangan, dan portal orang tua. Sistem multi-peran RBAC, mode offline, dashboard real-time, analitik AI, dan dukungan penuh pendidikan Indonesia.',
      'product.sis.featuresTitle': 'Manajemen Sekolah <span>Lengkap</span>',
      'product.sis.feat1.title': 'Multi-Peran RBAC',
      'product.sis.feat1.desc': 'Autentikasi JWT + 2FA dengan kontrol akses berbasis peran. Mendukung admin, kepala sekolah, guru, siswa, orang tua, dan staf dengan izin granular.',
      'product.sis.feat2.title': 'Sistem Kehadiran',
      'product.sis.feat2.desc': 'Entri manual, scan QR code, kartu RFID, dan fingerprint. Pelacakan real-time, geo-fencing, deteksi terlambat/pulang awal, dan notifikasi otomatis ke orang tua.',
      'product.sis.feat3.title': 'Manajemen Nilai',
      'product.sis.feat3.desc': 'Pengetahuan, Keterampilan, Sikap, Rapor, dan Ranking. Rapor otomatis, ranking kelas, analisis mata pelajaran, dan perhitungan nilai sesuai standar kurikulum Indonesia.',
      'product.sis.feat4.title': 'Ujian CBT Online',
      'product.sis.feat4.desc': 'Manajemen bank soal, seleksi soal acak, timer ujian, koreksi otomatis, anti-cheat, dan analisis hasil instan untuk Computer Based Testing.',
      'product.sis.feat5.title': 'Platform e-Learning',
      'product.sis.feat5.desc': 'Materi pembelajaran, tugas, forum diskusi, pengumpulan file, penilaian, dan pelacakan kemajuan. LMS bawaan tanpa perlu platform terpisah.',
      'product.sis.feat6.title': 'Keuangan & SPP',
      'product.sis.feat6.desc': 'Manajemen SPP, pembuatan invoice, pelacakan pembayaran, cicilan, pengingat jatuh tempo, dan laporan keuangan komprehensif untuk administrasi sekolah.',
      'product.sis.feat7.title': 'Portal Orang Tua',
      'product.sis.feat7.desc': 'Tampilan khusus orang tua untuk nilai, kehadiran, jadwal, status pembayaran, komunikasi guru, dan chat. Tetapkan orang tua terlibat dalam pendidikan anak.',
      'product.sis.feat8.title': 'Analitik AI',
      'product.sis.feat8.desc': 'Analisis kinerja siswa berbasis AI, prediksi putus sekolah, wawasan pola belajar, rekomendasi otomatis, dan chatbot bahasa alami untuk kueri data sekolah.',
      'product.sis.feat9.title': 'Notifikasi',
      'product.sis.feat9.desc': 'Notifikasi WhatsApp, Email, dan Telegram untuk kehadiran, nilai, pembayaran, pengumuman, dan peringatan darurat. Orang tua dan siswa tetap informasi secara otomatis.',
      'product.sis.use1.title': 'Sekolah Dasar & Menengah',
      'product.sis.use1.desc': 'Manajemen SD, SMP dengan dukungan Kurikulum Merdeka. Kehadiran, rapor, komunikasi orang tua, dan tagihan SPP untuk operasional harian.',
      'product.sis.use2.title': 'SMA & Kejuruan',
      'product.sis.use2.desc': 'SMA/SMK dengan spesialisasi jurusan, pelacakan kompetensi, persyaratan kelulusan, dan manajemen data persiapan universitas.',
      'product.sis.use3.title': 'Dinas Pendidikan',
      'product.sis.use3.desc': 'Dinas Pendidikan yang mengelola beberapa sekolah. Dashboard agregat, laporan kabupaten, penugasan guru, dan manajemen kebijakan terpusat.',
      'product.sis.use4.title': 'Bimbel & Kursus',
      'product.sis.use4.desc': 'Pusat bimbel dan kursus dengan pendaftaran siswa, penjadwalan kelas, kehadiran, pelacakan kemajuan, dan manajemen pembayaran untuk pembelajaran fleksibel.',
      'product.sis.tech1.title': 'Stack Backend',
      'product.sis.tech2.title': 'Stack Frontend',
      'product.sis.tech3.title': 'Database & Performa',
      'product.sis.tech4.title': 'Keamanan & Integrasi',
      'product.sis.downloadTitle': 'Dapatkan Klat SIS <span>Hari Ini</span>',
      'product.sis.downloadDocker': 'Deploy dengan Docker',
      'product.sis.faq1.q': 'Apakah Klat SIS gratis?',
      'product.sis.faq1.a': 'Ya! Klat SIS 100% gratis dan open source (GPL-3.0). Tidak ada biaya langganan, tidak ada biaya per siswa, tidak ada biaya tersembunyi. Semua fitur tersedia termasuk CBT, e-learning, dan analitik AI.',
      'product.sis.faq2.q': 'Berapa banyak siswa yang bisa ditangani?',
      'product.sis.faq2.a': 'Klat SIS mendukung 100K+ catatan siswa dengan query yang dioptimasi, indexing yang tepat, dan caching Redis. Telah diuji dengan sekolah tunggal 5.000+ siswa dan deployment kabupaten 100.000+ siswa.',
      'product.sis.faq3.q': 'Apakah mendukung Kurikulum Merdeka?',
      'product.sis.faq3.a': 'Ya! Klat SIS mendukung penuh Kurikulum Merdeka (kurikulum Indonesia saat ini) termasuk PPKn, jenis penilaian (Pengetahuan, Keterampilan, Sikap), dan tracking proyek P5. Juga mendukung Kurikulum 2013 untuk masa transisi.',
      'product.sis.faq4.q': 'Apakah bisa offline?',
      'product.sis.faq4.a': 'Ya! Klat SIS memiliki arsitektur PWA offline-first. Guru dan siswa bisa menggunakan sistem tanpa internet. Data tersinkron otomatis saat koneksi tersedia. Sempurna untuk daerah dengan internet tidak stabil.',
      'product.sis.faq5.q': 'Bagaimana sistem CBT bekerja?',
